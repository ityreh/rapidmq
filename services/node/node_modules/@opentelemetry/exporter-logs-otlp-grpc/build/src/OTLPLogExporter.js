...
class OTLPLogExporter extends otlp_grpc_exporter_base_1.OTLPGRPCExporterNodeBase {
    constructor(config = {}) {
        super(config);
        const headers = Object.assign(Object.assign({}, USER_AGENT), core_1.baggageUtils.parseKeyPairsIntoRecord((0, core_1.getEnv)().OTEL_EXPORTER_OTLP_LOGS_HEADERS));
    ...
    getServiceClientType() {
        return otlp_grpc_exporter_base_1.ServiceClientType.LOGS;
    }
    getServiceProtoPath() {
    ...
    getUrlFromConfig(config) {
        ...
        return ((0, core_1.getEnv)().OTEL_EXPORTER_OTLP_LOGS_ENDPOINT ||
